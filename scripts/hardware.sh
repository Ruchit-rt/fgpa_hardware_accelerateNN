...
icpx -v -fsycl -fintelfpga -DFPGA_HARDWARE src/tester.cpp -Xshardware -o tester_2Kernel_repeat.fpga -Xstarget=intel_s10sx_pac:pac_s10_usm $(pkg-config --cflags --libs opencv4)
